...
public class SplashScreenFrame extends javax.swing.JFrame {
    ...
    class SplashThread extends Thread//SplashThread gets methods of Thread due to inheritence&those of Frame due to being inner class.
{
    public void run()
    {
       int count=1;
       Random r=new Random();
        while(jProgressBar1.getValue()<jProgressBar1.getMaximum())//agar ye loop Frame ke cons. me likh dete to main thread hi sleep ho jata.
        {
         try
            {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Himanshu raj\\Desktop\\Core java new Project\\Sanjeevani App\\icon\\sps.jpg")); // NOI18N
