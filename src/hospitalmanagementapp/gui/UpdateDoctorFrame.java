...
String password,rePassword;
    ...
    private void initComponents() {
        ...
        txtDoctorName.setBackground(new java.awt.Color(204, 255, 204));
        txtDoctorName.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N

        jcbUserId.setBackground(new java.awt.Color(204, 255, 204));
        jcbUserId.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jcbUserId.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                jcbUserIdItemStateChanged(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(txtDoctorName, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 182, Short.MAX_VALUE)
                            .addComponent(jcbUserId, javax.swing.GroupLayout.Alignment.LEADING, 0, 182, Short.MAX_VALUE)
    ...
    private void jcbUserIdItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jcbUserIdItemStateChanged
        txtDoctorName.setText(doctorList.get(jcbUserId.getSelectedItem().toString()));
    }//GEN-LAST:event_jcbUserIdItemStateChanged
    ...
    private void btnUpdatePasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdatePasswordActionPerformed
        ...
        try
        {
            boolean result=UserDao.changePassword(jcbUserId.getSelectedItem().toString(),password);
            if(!result)
            {
    ...
    private javax.swing.JComboBox<String> jcbUserId;
...
public void loadDoctorsList()
{
    try
    {
        doctorList=DoctorsDao.getDoctorList();
        if(doctorList.size()==0)
        {
            JOptionPane.showMessageDialog(null,"No registered Doctors present");
            return;
        }
        Set <String> doctorIds=doctorList.keySet();
        for(String id:doctorIds)
        {
            jcbUserId.addItem(id);
        }
    }
    catch(Exception e)
        {
